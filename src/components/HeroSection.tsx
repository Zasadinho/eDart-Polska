      ...
      <div className="container mx-auto px-4 py-16 md:py-24 relative">
        <div className="max-w-3xl">
          ...
          <motion.h1
            ...
            className="text-4xl md:text-6xl lg:text-7xl font-display font-bold leading-tight mb-4"
          >
          ...
          <motion.p
            ...
            className="text-lg md:text-xl text-muted-foreground font-body max-w-xl mb-8"
          >
          ...
          >
            <Link to="/ton-stats">
              <Button variant="hero" size="lg">
                <Flame className="h-4 w-4 mr-2" /> Wtryski
              </Button>
            </Link>
            <Link to="/matches">
...
const StatChip = ({ icon, label, value }: { icon: React.ReactNode; label: string; value: string }) => (
  <motion.div
    ...
    className="flex items-center gap-2 bg-muted/50 rounded-lg px-4 py-2 border border-border backdrop-blur-sm"
  >
